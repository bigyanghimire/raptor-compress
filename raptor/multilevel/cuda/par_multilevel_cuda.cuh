...
#ifndef RAPTOR_ML_PARMULTILEVEL_CUDA_H
#define RAPTOR_ML_PARMULTILEVEL_CUDA_H
...
#include "raptor/multilevel/cuda/par_multilevel_cuda.cuh"
#ifdef USING_HYPRE
...
namespace raptor
{
    class ParMultilevelCuda
    {
    public:
        ParMultilevelCuda(double _strong_threshold,
